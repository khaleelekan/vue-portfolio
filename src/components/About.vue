  ...
  <section id="about" class="py-20 bg-gray-50 dark:bg-gray-800">
    <div class="container px-6 mx-auto">
      ...
      <div class="grid items-center max-w-6xl gap-12 mx-auto md:grid-cols-2">
        <!-- Avatar and Bio -->
        <div class="space-y-6">
          <div class="w-64 h-64 mx-auto overflow-hidden border-4 border-white rounded-full shadow-xl dark:border-gray-700">
            <img src="" alt="Developer Avatar" class="object-cover w-full h-full">
          </div>
        ...
        <!-- Skills -->
        <div class="space-y-8">
          <h3 class="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Technical Skills</h3>
          ...
          <div v-for="skill in skills" :key="skill.name" class="space-y-2">
            ...
            <div class="h-2 overflow-hidden bg-gray-200 rounded-full dark:bg-gray-700">
              <div 
                class="h-full transition-all duration-1000 ease-out rounded-full bg-primary-500" 
